...
import com.shangzuo.highvaluecabinet.ui.widget.arcface.OnRegisterFinishedCallback;
import com.shangzuo.highvaluecabinet.ui.widget.arcface.PreviewConfig;
import com.shangzuo.highvaluecabinet.ui.widget.arcface.face.FaceHelper;
...
import com.shangzuo.highvaluecabinet.ui.widget.arcface.face.constants.RecognizeColor;
...
public class RecognizeViewModel extends BaseViewModel implements RecognizeCallback {
    /**
     * 人脸识别过程中数据的更新类型
     */
    ...
    public void init() {
        ...
        recognizeConfiguration.postValue(configuration);
    }
    ...
    public List<FacePreviewInfo> onPreviewFrame(byte[] nv21, boolean doRecognize) {
        if (faceHelper != null) {
            if (!loadFaceList) {
                ...
                return new ArrayList<FacePreviewInfo>();
            }
            if (livenessType == LivenessType.IR && irNV21 == null) {
                Log.e(TAG, "LivenessType: ");
                return new ArrayList<FacePreviewInfo>();
            }
